...
public class Contenido {
    ...
    public Contenido(String titulo, String descripcion, int duracion, Genero genero, LocalDate fechaEstreno) {
        this.titulo = titulo;
    ...
    public Contenido(String titulo, String descripcion, int duracion, Genero genero, double calificacion, LocalDate fechaEstreno, boolean disponible) {
